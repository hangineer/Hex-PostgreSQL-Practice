...
-- 3-2. 新增：承1，為三名教練新增專長資料至 `COACH_LINK_SKILL` ，資料需求如下：
    ...
    VALUES
      (
        (SELECT id FROM "COACH" WHERE user_id = (SELECT id FROM "USER" WHERE email = 'lee2000@hexschooltest.io')),
        (SELECT id FROM "SKILL" WHERE name = '瑜伽') -- 資料庫有打錯字
      );
...
-- 參考
-- 1. https://github.com/ellaYang1227/backend-database-camping-task-startkit/blob/main/migrations/task/sqls/20241021064214-task-up.sql
-- 2. https://hackmd.io/@WuPeiTing0919/rJkNSrQ71g#%F0%9F%9A%A9-58-%E3%80%90%E6%8C%91%E6%88%B0%E9%A1%8C%E3%80%91-%E6%9F%A5%E8%A9%A2%E8%B3%87%E6%96%99
SELECT
