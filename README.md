...
本專案為「六角學院 - 後端資料庫體驗營」的作業，練習如何使用 Docker 來開啟 postgresSQL 容器，並透過 DBever 去連接本地端的 postgresSQL 資料庫，依照題目練習寫 postgreSQL 語法
## 快速連結
...
* [個人筆記 的連結](https://luminous-mule-717.notion.site/2024-12a8722405bf80d3bfaaeae56887d85a)
